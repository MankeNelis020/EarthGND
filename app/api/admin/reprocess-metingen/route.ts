 ...
 *
 * NIET idempotent — elke aanroep reset én heraccumuleert global_prior en
 * regional_prior. Twee aanroepen zonder reset tussendoor leidt tot
 * dubbele Welford-accumulatie. Altijd slechts één keer aanroepen per
 * databatch.
 */
